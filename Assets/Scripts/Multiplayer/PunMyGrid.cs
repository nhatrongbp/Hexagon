...
public class PunMyGrid : MonoBehaviour
{
    public int columns = 7, rows = 7;
    //public ShapePooling shapePooling;
    [SerializeField] PunMyGridSquare gridSquare;
    [SerializeField] MyGridSquareSoul gridSquareSoul;
    float cellSize;
    Vector2 _startPos;
    bool[,] _visited;
    PunMyGridSquare[,] _gridSquares;
    ...
    {
        _gridSquares = new PunMyGridSquare[columns, rows];
    ...
    void CheckIfShapeCanBePlaced(int shapeSize)
    {
        ...
        if (_hoveringSquare.Count == shapeSize)
        {
            ...
            // PunEvents.SendFinishDroppingShapeEvent(true);
        ...
        else
        {
            ...
            //TO DO: raise an event
            // PunEvents.SendFinishDroppingShapeEvent(false);
    ...
    IEnumerator UnoccupyAdjacentSquares()
    {
        ...
        //TO DO: raise an event
        // PunEvents.SendGenerateRandomShapeEvent();
